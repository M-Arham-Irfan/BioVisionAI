...
// Extended Root component with closeOnOutsideClick prop
interface DialogProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Root> {
  closeOnOutsideClick?: boolean;
}

const Dialog = ({ closeOnOutsideClick = true, ...props }: DialogProps) => (
...
// Extended Content component to support the closeOnOutsideClick functionality
